...
You can choose to export all mockups or a subset, including any [alternates](/editor/b3/alternates/) you have created.
...
The shortcuts for exporting a mockup and project to image files are CTRL/CMD+R and CTRL/CMD+Shift+R, respectively. Exporting all mockups will also generate images for any [alternates](/editor/b3/alternates/) you have created.
...
You can also export your project for use in a previous version of Balsamiq Mockups or version that doesn't yet support the [new BMPR file format](/editor/b3/intro/#projects).
