...
Selecting Export > Project to BMMLs ZIP... will save your mockups as a ZIP file containing individual BMML files, images, and Symbols. You can then unzip it and open the mockups with an older version of Balsamiq Mockups.
