...
To use your project in Balsamiq Mockups 3 for Desktop all you need to do is download the file and open it using the Desktop version.

To use your project in an earlier version of Balsamiq Mockups you can export the entire project to your Google Drive as a .zip file. To do this go to "Project > Export > Project to BMMLs ZIP...". This will create a .zip file for you to download containing all the mockups, Symbols, and images in the current project.
