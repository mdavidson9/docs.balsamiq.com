...
Balsamiq for JIRA Server uses a behind the firewall service in order to allow real time collaboration, chat and other features.

In order to verify the correct functioning of the service you can use the configuration page of the add-on.
...
*   the fully qualified domain name of the server is correct. In most of the cases it is equivalent to the FQDN of the JIRA server instance.
